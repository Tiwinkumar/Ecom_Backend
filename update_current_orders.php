...
$sql = mysqli_query($db,"UPDATE customerdetail SET status='$status' WHERE id='$id'");
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"><title>Current Orders</title>
    ...
    <div class="page-container">
        ...
        <main class="main-content bgc-grey-100">
            <div class="container-fluid">
                <h2 class="c-grey-900 mT-10 mB-30">Orders Report</h2>
...
?>
            ...
            <div id="mainContent">
                <div class="container-fluid">
                  <form method="POST" action="update_current_orders.php" enctype="multipart/form-data">
                        <div class="bgc-white bd bdrs-3 p-20 mB-20">
                            <div class="form-row">
                                <div class=" form-group col-md-4">
                                        <input type="text" class="form-control" style="visibility: hidden;"  name="id" id="id" value="<?php echo"$id" ?>"   readonly>
                                </div>    
                                <div class="form-group col-md-4">
                                    <label>Order Status</label>
                                        <select type="text" id="offer_status" class="form-control" name="offer_status" class="form-control" style="height: 35px;">
                                            <option value="Pending">Pending</option>
                                            <option value="Delivered">Delivered</option>
                                            <option value="Cancelled">Cancelled</option>
                                        </select>
                                </div>
                            <div class="wrapper col-md-12" style="align-self: center;">
                                <button type="submit" class="btn-change" name="update">Update</button>
                            </div>
                        </div>
                    </div>            </div>
