...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"><title>Add Items</title>
		...
		<main class="main-content bgc-grey-100">
			<div id="mainContent">
				<div class="container-fluid">
				  <form method="POST" action="process_item.php" enctype="multipart/form-data">
					<h2 class="c-grey-900 mT-10 mB-30">Add Items</h2>
						<div class="bgc-white bd bdrs-3 p-20 mB-20">
							<div class="form-row">
								<div class=" form-group col-md-3">
									<label>Item Name</label>
      									<input type="text" class="form-control"  name="item_name" id="product_name" placeholder="Classic veg Burger" required>
								</div>
								<div class="form-group col-md-3">
									<label>Item Category</label>
									<select type="text" id="product_category" class="form-control" name="item_category" class="form-control" style="height: 35px;font-size: 16px;">
								...
								<div class="form-group col-md-3">
									<label>Item Ingredients</label>
      									<input type="text" class="form-control" name="item_ingredients" id="product_ingrdients" placeholder="Salt,Egg,Capsicum etc...">
								</div>
								<div class="form-group col-md-3">
									<label>Product Price</label>
      								<input type="text" class="form-control" name="item_price"   id="product_price" placeholder="150.00">
								</div>
								
								<div class="wrapper col-md-12">
  								<button type="submit" class="btn-change" name="submit">Add Item</button>
							</div>
							</div>
      ...
      if(mysqli_num_rows($result) > 0) {
		...
		echo"<tbody>";         
         while($row = mysqli_fetch_array($result)){
            ...
            echo "<td>";
                                            echo "<a href='update_item.php?id=". $row['id'] ."' title='Update Record' data-toggle='tooltip'><span class='glyphicon glyphicon-pencil'></span></a>";
                                            echo "<a href='process_item.php?del=". $row['id'] ."' title='Delete Record' data-toggle='tooltip'><span class='glyphicon glyphicon-trash'></span></a>";
                                        echo "</td>";
            echo "</tr>";
         }
         echo "</tbody>";
