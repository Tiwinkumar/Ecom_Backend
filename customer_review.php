...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"><title>Customer Reviews </title>
		...
		<main class="main-content bgc-grey-100">
			<div id="mainContent">
				<div class="container-fluid">
				  <div class="container-fluid">
				<h2 class="c-grey-900 mT-10 mB-30">Customer Reviews</h2>
...
<?php
  ...
  // $sql = 'SELECT * FROM basic  WHERE psta="$psta"';
   ...
   $sql= "SELECT * FROM soup_review ORDER BY id DESC ";
      ...
      if(mysqli_num_rows($result) > 0) {
		...
		echo"<tbody>";         
         while($row = mysqli_fetch_array($result)){
            ...
            echo "<td>";
                                            echo "<a href='delete_review.php?del=". $row['id'] ."' title='Delete Record' data-toggle='tooltip'><span class='glyphicon glyphicon-trash'></span></a>";
            echo "</td>";
            echo "</tr>";
         }
         echo "</tbody>";
