...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"><meta http-equiv="refresh" content="60"><title>Pending Orders</title>
	...
	<div class="page-container"><div class="header navbar"><div class="header-container">
		...
		<main class="main-content bgc-grey-100">
			<div id="mainContent"><div class="container-fluid">
				<h2 class="c-grey-900 mT-10 mB-30">Pending Orders Full Report</h2>
...
<?php
  ...
  // $sql = 'SELECT * FROM basic  WHERE psta="$psta"';
   ...
   $sql= "SELECT * FROM customerdetail WHERE status='Pending' ";
